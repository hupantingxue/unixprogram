...
class Printer;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::PrintDemo::Printer>&);
::IceProxy::Ice::Object* upCast(::IceProxy::PrintDemo::Printer*);
...
bool operator<(const Printer&, const Printer&);
::Ice::Object* upCast(::PrintDemo::Printer*);
typedef ::IceInternal::Handle< ::PrintDemo::Printer> PrinterPtr;
typedef ::IceInternal::ProxyHandle< ::IceProxy::PrintDemo::Printer> PrinterPrx;
...
public:
    ...
    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, const ::PrintDemo::Callback_Printer_printStringPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_printString(s, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_printString(const ::std::string& s, const ::Ice::Context& __ctx, const ::PrintDemo::Callback_Printer_printStringPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_printString(s, &__ctx, __del, __cookie);
    }
...
class Printer : virtual public ::IceDelegate::PrintDemo::Printer,
